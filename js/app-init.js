	...
	var appInit = function(){
		...
		app.run(['$couchPotato', '$state', '$stateParams', '$rootScope',
			...
			stateProvider.state('root', {
				...
				views: {
					"main@":{
						templateUrl: '/game-server/index.html',
						resolve:{
							deps: couchPotatoProvider.resolveDependencies(['/game-server/index.js'])
						},
							controller: 'GameServerController as ctrl'
					}
				}
			});	
			...
			for(var key in states){
				...
				stateProvider.state(key,{
					...
					resolve:{
						deps: couchPotatoProvider.resolveDependencies(['/'+ state.path + '/index.js'])
					},
