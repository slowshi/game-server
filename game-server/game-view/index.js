define(['app'],function(app){
	...
	app.registerController('GameViewController',['$scope','cssInjector','$element','$state','$window','EventEmitter',function($scope,cssInjector,$element,$state,$window,EventEmitter){
		...
		this.EventEmitter.subscribe('windowResize',resizeWindow);
		this.loadView = '';
		...
		this.EventEmitter.subscribe('GameView:ChangeState',this.onChangeState.bind(this));
		resizeWindow();
	}])
});