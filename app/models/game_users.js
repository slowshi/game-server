module.exports = {
	...
	'hecarim','heimerdinger','illaoi','irelia','janna','jarvan','jax','jayce','jinx',
	'kalista','karma','karthus','kassadin','katarina','kayle','kennen','kha_zix','kindred',
	'kog_maw','leblanc','lee_sin','leona','lissandra','lucian','lulu','lux','malphite','malzahar',
	'maokai','master_yi','miss_fortune','mordekaiser','morgana','nami','nasus','nautilus','nidalee',
	'nocturne','loss_of_ban','nunu','olaf','orianna','pantheon','poppy','quinn','rammus','rek_sai',
	'renekton','rengar','riven','rumble','ryze','sejuani','shaco','shen','shyvana','singed','sion','sivir',
